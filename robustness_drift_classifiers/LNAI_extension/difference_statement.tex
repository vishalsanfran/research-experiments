...
comparison in a single view.  Nine new figures accompany the extended experiments:
...
HIKARI-2021 robustness curves, the PGD step-size ablation, and the ESI drift
curves comparing ZOO versus Square Attack.
